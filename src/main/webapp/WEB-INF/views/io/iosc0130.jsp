	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">소요량분석(레이저)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
	...
	<div class="modal modal-alert fade" id="resetModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="resetModal" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6>소요량분석(레이저) 새로고침/수정 방식을 선택해주세요. </h6>
				</div>
				<div class="modal-footer">
									...
									<td>
										<div class="row">
		                                 	<div class="custom-control custom-radio row">
		                                    	...
		                                    	<label class="custom-control-label input-label-sm" for="mg1">레이저</label>
		                                 	</div>
		                                 	<div class="custom-control custom-radio row">
		...
		<div class="modal-dialog modal-xl" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-primary" id="btnConsumptAnalz">소요량분석(레이저)</button>
						<button type="button" class="btn btn-secondary" data-dismiss="modal">닫기</button>
					</div>
				</div>
			</div>
...
<script>
	...
	var status = "";				//소요량분석(레이저) 목록조회시 조건
	var statusOptionVal = '002'; 		//소요량분석(레이저) 상태값
	var itemSeqVal=null;
	var dealGubun = "";
	...
	$('#bizOrderAdmTable tbody').on('click','tr',function() {
		...
		status = 'read';		//소요량클릭시 소요량분석(레이저) 목록조회 조건
		sideView = "edit";
