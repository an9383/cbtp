	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">발주관리(레이저)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
	...
	let purchaseOrderDtlTable = $('#purchaseOrderDtlTable').DataTable({
		...
		columns : [
			...
			{data : 'unOrdQty',
				render : function(data, type, row, meta){
					if(data!=null){
						return '<input type="text" class="form-control number-float0" name="unOrdQty" value="'+addCommas(data)+'" style="text-align:right;" disabled>';		
			...
			{data : 'ordQty',
				render : function(data, type, row, meta){
					if(data!=null){
						return '<input type="text" class="form-control number-float0" name="ordQty" value="'+addCommas(data)+'" style="text-align:right;" >';		
			...
			{data : 'ordUnitCost',
				render : function(data, type, row, meta){
					if(data!=null){
						return '<input type="text" class="form-control number-float0" name="ordUnitCost" value="'+addCommas(data)+'" style="text-align:right;">';		
