	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">자재출고(정밀가공)</li>
			</ol>
		</nav>
	</header>
							...
							<div class="table-responsive">
								<table id="barcodeAdmTable" class="table table-bordered">
									...
									<tr>
										<th>창고</th>
										<td colspan="3">
											<input type="text"style="max-width: 100%;" class="form-control" value="정밀가공(현장)창고" disabled>
...
<script>
	...
	let currentHref = "iosc0440";
	let currentPage = $('.' + currentHref).attr('id');
	
	$('#'+currentPage).closest('.has-child','li').addClass('has-open has-active');
	$('#'+currentPage).closest('.menu-item').addClass('has-active');    
	$(document).attr("title","자재출고(정밀가공)"); 
