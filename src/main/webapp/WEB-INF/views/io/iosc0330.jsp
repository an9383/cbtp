	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">입출고원장(레이저)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
						...
						<table id="stockPaymentStatusTable" class="table table-bordered tr_highlight_row">
							<thead class="thead-light">
								<tr>
									...
									<th class="text-center" rowspan='2' style="min-width: 60px;">CUT SIZE</th>
									<th class="text-center" rowspan='2' style="min-width: 60px;">PNL SIZE</th>
