	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">자재출고(레이저)</li>
			</ol>
		</nav>
	</header>
							...
							<div class="table-responsive">
								<table id="barcodeAdmTable" class="table table-bordered">
									...
									<tr>
										<th>창고</th>
										<td colspan="3">
											<input type="text"style="max-width: 100%;" class="form-control" value="레이저(현장)창고" disabled>
											<input type="hidden"style="max-width: 100%;" class="form-control" id="locationNo" value="20230112-001">
											<input type="hidden"style="max-width: 100%;" class="form-control" id="locationCd" value="014">
										</td>
									</tr>
									<tr>
										<th>Barcode No</th>
