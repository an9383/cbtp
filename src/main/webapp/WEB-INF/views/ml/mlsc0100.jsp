						...
						<table id="equipCodeTable" class="table table-bordered">
							...
							<thead class="thead-light">
								<tr>
									...
									<th style="vertical-align: middle;">철형타발수</th>
...
//						$('#btnAddConfirmLoading').addClass('d-none');
	...
	$("#btnPrint").on('click', function() {
		...
		if (tableData != null) {
			...
			obj.moldLocation = tableData.moldLocation; // 철형위치
			obj.equipCavity = tableData.equipCavity; // Cavity
			obj.equipNo = tableData.equipNo; // 철형관리번호
...
//Do printing...
	function labelPrint(data, action) {
	   ...
	   let cmd = "";
	      ...
	      cmd += "{PV23;0015,0230,0040,0040,01,0,00,B=철형코드|}";
	      ...
	      cmd += "{PV23;0360,0230,0040,0040,01,0,00,B=철형위치|}";
