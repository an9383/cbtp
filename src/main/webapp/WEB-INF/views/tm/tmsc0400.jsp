	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">현재고현황(정밀가공)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
				...
				<div class="card">
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="inventoryTable">
							...
							<tfoot>
								<tr>
									<td colspan="6" style="text-align: center !important; background-color:#aed3ec">합계</td>
...
<script>
	...
	let currentHref = "tmsc0400";
	let currentPage = $('.' + currentHref).attr('id');
	$(document).attr("title", "현재고현황(정밀가공)");
	...
	let inventoryTable = $('#inventoryTable').DataTable({
		...
		drawCallback: function() {
			...
			let sumRealQty = $('#inventoryTable').DataTable().column(6,{ page: 'current'} ).data().sum();
