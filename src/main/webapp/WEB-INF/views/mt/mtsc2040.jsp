						...
						<thead>
							<tr>
								...
								<th class="text-center align-middle">
									<select class="text-right" id="searchDate" style="color: white; background: #212529; border: none; font-size: 1.5rem;"onchange="dataSearch();"></select>
								</th>
							</tr>
						</thead>
					</table>
	...
	function dataInsert(dateCount, dataType) {
		...
		if(dataType == 'grape') {
			...
			for(let i=0; i<dateCount.length; i++) {
				...
				html += '<td class="text-end align-middle">'+addCommas(dateCount[i].faultyQty)+'</td>';
				if(totalFaultyQty==0) {
