						...
						<thead>
							<tr>
								...
								<th class="text-center align-middle">
									<input type="month" id="searchDate" style="color: white; background: #212529; border: none; font-size: 1.5rem;" onchange="dataSearch();">
								</th>
								<th class="text-center align-middle">
									<select id="equipCd" style="color: white; background: #212529; border: none; font-size: 1.5rem;" onchange="dataSearch();"></select>
								</th>
							</tr>
						</thead>
					</table>
				...
				<div class="container-fluid p-0 h-100">
					<table class="table table-bordered table-dark p-0" id="yearTable" style="font-size: 1.2rem;">
						...
						<thead>
							...
							<tr>
								<th class="text-center align-middle">설비성능</th>
...
<script>
	...
	function dateLineInsert(dateCount) {
		...
		let html6 = '<tr>';
		html6 += '<th class="text-center align-middle">설비설능</th>';
