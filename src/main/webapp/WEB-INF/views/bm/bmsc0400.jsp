	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">제품정보관리(정밀가공)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
					...
					<div class="table-responsive">
						<table id="itemPartAdmTable" class="table table-bordered">
							...
							<thead class="thead-light">
								<!--==========table thead 추가==========-->
								<tr>
									<th class="text-center" style="min-width: 50px;" id="itemCusLeftTh">고객사</th>
									<th class="text-center" style="min-width: 50px;">품번</th>
									<th class="text-center" style="min-width: 50px;">품명</th>
									<th class="text-center" style="min-width: 50px;">충진중량</th>
									<th class="text-center" style="min-width: 50px;">저장위치</th>
									<th class="text-center" style="min-width: 50px;">구역/위치</th>
									<th class="text-center" style="min-width: 50px;">비닐포장수</th>
									<th class="text-center" style="min-width: 50px;">박스당비닐포장수</th>
									<th class="text-center" style="min-width: 50px;">파레트당박스수량</th>
									<th class="text-center" style="min-width: 50px;">사용여부</th>
								</tr>
							</thead>
						</table>
					</div>
								...
								<div class="table-responsive">
									...
									<table class="table table-bordered" id="itemPartInfoTable">
										...
										<tr id="prodGubunDiv" class="d-none">
											...
											<td><select class="custom-select d-none" id="prodGubun" style="min-width : 100%;" disabled></select></td>
											<th></th>
											<td></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="exportCost" name="exportCost" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
										...
										<!-- 좌측 설정 -->
										<tr>
											<th rowspan="9">작업정보</th>
										</tr>
										<tr>
											<th>준비시간 (분)</th>
											<td>
												<input type="text" class="form-control" id="readyTime" name="readyTime" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>가공시간 (초)</th>
											<td>
												<input type="text" class="form-control" id="processTime" name="processTime" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>박스당 비닐포장수(EA)</th>
											<td>
												<input type="text" class="form-control" id="boxCount" name="boxCount" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>충진중량(개별) (g)</th>
											<td>
												<input type="text" class="form-control" id="fillingWt" name="fillingWt" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>파레트당 박스수량 (박스)</th>
											<td>
												<input type="text" class="form-control" id="paleBox" name="paleBox" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>비닐포장 수량(EA)</th>
											<td>
												<input type="text" class="form-control" id="fillingCount" name="fillingCount" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>실링기준값</th>
											<td>
												<input type="text" class="form-control" id="itemSeal" name="itemSeal" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
<!-- 										<tr> -->
<!-- 											<th>온도</th> -->
<!-- 											<td> -->
<!-- 												<input type="text" class="form-control" id="itemTemp" name="itemTemp" maxlength="30" dir="rtl" value="0" style="min-width : 100%;"> -->
<!-- 											</td> -->
<!-- 											<th>압력</th> -->
<!-- 											<td> -->
<!-- 												<input type="text" class="form-control" id="itemPress" name="itemPress" maxlength="30" dir="rtl" value="0" style="min-width : 100%;"> -->
<!-- 											</td> -->
<!-- 										</tr> -->
										<tr>
											<th>온도(상한)</th>
											<td>
												<input type="text" class="form-control" id="itemTempMax" name="itemTempMax" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>온도(하한)</th>
											<td>
												<input type="text" class="form-control" id="itemTempMin" name="itemTempMin" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>압력(상한)</th>
											<td>
												<input type="text" class="form-control" id="itemPressMax" name="itemPressMax" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>압력(하한)</th>
											<td>
												<input type="text" class="form-control" id="itemPressMin" name="itemPressMin" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>시간(상한)</th>
											<td>
												<input type="text" class="form-control" id="itemTimeMax" name="itemTimeMax" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
											<th>시간(하한)</th>
											<td>
												<input type="text" class="form-control" id="itemTimeMin" name="itemTimeMin" maxlength="30" dir="rtl" value="0" style="min-width : 100%;">
											</td>
										</tr>
										<tr>
											<th>비고</th>
											<td colspan="3">
												<input type="text" class="form-control" id="workDesc" name="workDesc" maxlength="128" style="min-width: 100%;">
											</td>
										</tr>
...
<script>
	...
	let currentHref = "bmsc0400";
	let currentPage = $('.' + currentHref).attr('id');

	$('#' + currentPage).closest('.has-child', 'li').addClass('has-open has-active');
	$('#' + currentPage).closest('.menu-item').addClass('has-active');
	$(document).attr("title", "제품정보관리(정밀가공)");
	...
	selectBoxAppend(savelocCd, "savelocCd", "", "2");
		...
		columns : [
			...
			{//구역/위치
				...
				render : function(data, type, row, meta) {
					if(data != null){
						return row['locationNm'] + '/' + row['floorNm'];
					} else return '-';
				}
			}, 
			{//비닐포장수
		...
		$.ajax({
			...
			success : function(res) {
				...
				if (res.result == 'ok') {
					...
					$('#paleBox').val(data.paleBox != null ? rmDecimal(data.paleBox) : '0');
					$('#smallPackage').val(data.smallPackage != null ? rmDecimal(data.smallPackage) : '0');
					$('#itemSpec').val(data.itemSpec);
// 					$('#itemTemp').val(data.itemTemp != null ? rmDecimal(data.itemTemp) : '0');
					$('#itemSeal').val(data.itemSeal != null ? rmDecimal(data.itemSeal) : '0');
// 					$('#itemPress').val(data.itemPress != null ? rmDecimal(data.itemPress) : '0');
					...
					$('#workDesc').val(data.workDesc);
					$('#readyTime').val(data.readyTime != null ? rmDecimal(data.readyTime) : '0');
					$('#processTime').val(data.processTime != null ? rmDecimal(data.processTime) : '0');
					$('#fillingCount').val(data.fillingCount != null ? rmDecimal(data.fillingCount) : '0');
					...
					$('#fillingWt').val(data.fillingWt != null && data.fillingWt != '' ? rmDecimal(data.fillingWt) :'0');
					...
					$('#itemTempMax').val(data.itemTempMax != null ? rmDecimal(data.itemTempMax) : '0');
					$('#itemTempMin').val(data.itemTempMin != null ? rmDecimal(data.itemTempMin) : '0');
					$('#itemPressMax').val(data.itemPressMax != null ? rmDecimal(data.itemPressMax) : '0');
					$('#itemPressMin').val(data.itemPressMin != null ? rmDecimal(data.itemPressMin) : '0');
					$('#itemTimeMax').val(data.itemTimeMax != null ? rmDecimal(data.itemTimeMax) : '0');
					$('#itemTimeMin').val(data.itemTimeMin != null ? rmDecimal(data.itemTimeMin) : '0');
	...
	$('#btnAdd').on('click', function() {
		...
		selectBoxAppend(importYn, "importYn", "", "");
		selectBoxAppend(locationCd, "locationCd", "", "");
		selectBoxAppend(savelocCd, "savelocCd", "002", "2");
		selectBoxAppend(payMethodCd, "payMethodCd", "", "");
		selectBoxAppend(useYnCode, "useYnOne", "", "");
		selectBoxAppend(useYnCode, "useYnTwo", "", "");
		selectBoxAppend(useYnCode, "useYnThree", "", "");
	...
	$('#btnSave').on('click', function() {
		if (activeTab == "기본정보") {
			...
			if (itemGubunSaveData=="003" && (!$('#locNo').val())) {
			...
			if ($('#readyTime').val() == '0') {
				toastr.warning('준비시간을 입력해 주세요.');
				$('#readyTime').focus();
				return false;
			}
			
 			if ($('#processTime').val() == '0') {
 				toastr.warning('가공시간을 입력해 주세요.');
 				$('#processTime').focus();
 				return false;
 			}
			
			if ($('#fillingCount').val() == '0') {
				toastr.warning('충진개수를 입력해 주세요.');
				$('#fillingCount').focus();
				return false;
			}
			...
			$.ajax({
				...
				data : {
					...
					'exportCost' 	: function(){ return $('#exportCost').val().replace(/,/g, ''); },
					'exportDate' 	: function(){ return $('#exportDate').val().replace(/-/g, ''); },
					'paleBox' 		: function(){ return $('#paleBox').val().replace(/,/g, ''); },
...
// 					'smallPackage' 	: function(){ return $('#smallPackage').val().replace(/,/g, ''); },
					...
					'itemSeal' 		: function(){ return $('#itemSeal').val().replace(/,/g, ''); },
// 					'itemTemp' 		: function(){ return $('#itemTemp').val().replace(/,/g, ''); },
// 					'itemPress' 	: function(){ return $('#itemPress').val().replace(/,/g, ''); },
					...
					'workDesc' 		: function(){ return $('#workDesc').val(); },
					'readyTime' 	: function(){ return $('#readyTime').val().replace(/,/g, ''); },
					'processTime' 	: function(){ return $('#processTime').val().replace(/,/g, ''); },
					'fillingCount' 	: function(){ return $('#fillingCount').val().replace(/,/g, ''); },
					...
					'fillingWt' 	: function(){ return $('#fillingWt').val().replace(/,/g, ''); },
					...
					'itemTempMax' 	: function(){ return $('#itemTempMax').val().replace(/,/g, ''); },
					'itemTempMin' 	: function(){ return $('#itemTempMin').val().replace(/,/g, ''); },
					'itemPressMax'	: function(){ return $('#itemPressMax').val().replace(/,/g, ''); },
					'itemPressMin'	: function(){ return $('#itemPressMin').val().replace(/,/g, ''); },
					'itemTimeMax'	: function(){ return $('#itemTimeMax').val().replace(/,/g, ''); },
					'itemTimeMin'	: function(){ return $('#itemTimeMin').val().replace(/,/g, ''); },
				},
				success : function(res) {
					let data = res.data;
					if (res.result == 'ok') {
...
// 						$('#itemInformationTable').DataTable().ajax.reload(function() {});
	...
	html_import += '<button type="button" class="btn btn-warning float-left ml-2" id="btnImportDel">입고단가삭제</button>';
	html_import += '</div>';
	...
	//숫자 콤마생성
	$(document).on('keyup', "#importCost, #exportCost, #boxCount, #safetyStock, #smallPackage, #readyTime, #processTime, #fillingCount, #fillingWt, #paleBox, #itemSeal, #itemTempMax, #itemTempMin, #itemPressMax, #itemPressMin, #itemTimeMax, #itemTimeMin",  function(evt) { //입력시 콤마 추가
		var costSum = 0;
		if ($(this).val() == "") {
			$(this).val("0");
			$(this).select();
	...
	//숫자만 입력하게 처리
	$(document).on('keyup', "#prodWt, #srWt, #shotWt", function(event){
...
// 			$(this).val("0");
	...
	function uiProc(flag) {
		...
		$("#workDesc").attr("disabled", flag);
		$("#readyTime").attr("disabled", flag);
		$("#processTime").attr("disabled", flag);
		$("#fillingCount").attr("disabled", flag);
		...
		$("#itemSeal").attr("disabled", flag);
// 		$("#itemTemp").attr("disabled", flag);
// 		$("#itemPress").attr("disabled", flag);
		...
		$("#fillingWt").attr("disabled", flag);
		$("#prodWt").attr("disabled", flag);
		$("#srWt").attr("disabled", flag);
		$("#shotWt").attr("disabled", flag);
		
		$("#itemTempMax").attr("disabled", flag);
		$("#itemTempMin").attr("disabled", flag);
		$("#itemPressMax").attr("disabled", flag);
		$("#itemPressMin").attr("disabled", flag);
		$("#itemTimeMax").attr("disabled", flag);
		$("#itemTimeMin").attr("disabled", flag);
	}
	...
	let itemPrcssAdmTable = $('#itemPrcssAdmTable').DataTable({
		...
		columns : [ 
			...
			{//공정명
				...
				render : function ( data, type, row, meta ) {
					if ( data != null ) {
						return '<input type="text" class="form-control" name="itemPrcssNm" value="'+data+'" disabled>';
					} else {
						return '<input type="text" class="form-control" name="itemPrcssNm" value="" disabled>';
					}	
				}
			},
			{//외주처
			...
			{//비고
				...
				render : function ( data, type, row, meta ) {
					if ( data != null ) {
						return '<input type="text" class="form-control" name="itemPrcssDesc" value="'+data+'" disabled>';
					} else {
						return '<input type="text" class="form-control" name="itemPrcssDesc" value="" >';
					}	
				}
			}  
		],
	...
	$('#btnPrcssSave').on('click',function(){
		...
		if(itemPrcssAdmTable.data().count()>0){
			$('#itemPrcssAdmTable tbody tr').each(function(index, item){
				if ($('input[name=itemPrcssCd]').eq(index)=="") {
					toastr.warning('공정코드를 선택해주세요.');
					$('button[name=btnItemPrcssCd]').focus();
					return false;
				}	
				var rowData = new Object();
