...
jqSimpleConnect.connect = function(elementA, elementB, options) {
    ...
    connection.container = (options != null && options.container != null)? options.container: '';
    ...
    jQuery('#'+options.container).prepend(div.replace('divUniqueIdentifier', connection.id + '_1'));
    jQuery('#'+options.container).prepend(div.replace('divUniqueIdentifier', connection.id + '_2'));
    jQuery('#'+options.container).prepend(div.replace('divUniqueIdentifier', connection.id + '_3'));
